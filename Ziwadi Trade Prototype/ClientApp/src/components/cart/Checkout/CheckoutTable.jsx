...
loadColumns() {
  return [
    ...
    },
    {
      ...
      className: "checkout-table-cell",
      footerClassName: "checkout-table-footer",    Footer: <Button disabled={this.props.disableButton} className="checkout-btn" onClick={this.props.makeDonation}>Make Donation: {this.formatPrice(this.props.total)}</Button>,
